...
[uint256_constructor](/CryptoCompare.sol ':include :type=code :fragment=constructor')`
...
[uint256_request](/CryptoCompare.sol ':include :type=code :fragment=request')

#### 2c. Retrieve the response (example):

[uint256_response](/CryptoCompare.sol ':include :type=code :fragment=response')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/examples/coin-price-data/CryptoCompare.sol) of the above consumer contract.
