...
[get_uint256_constructor_om](/Optimism/get_uint256/get_uint256.sol ':include :type=code :fragment=constructor')
...
[get_uint256_request_om](/Optimism/get_uint256/get_uint256.sol ':include :type=code :fragment=request')
...
[get_uint256_no_multiply_constructor_om](/Optimism/get_uint256_no_multiply/get_uint256_no_multiply.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_uint256_request_no_multiply_om](/Optimism/get_uint256_no_multiply/get_uint256_no_multiply.sol ':include :type=code :fragment=request')
...
[get_int256_constructor_om](/Optimism/get_int256/get_int256.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_int256_request_om](/Optimism/get_int256/get_int256.sol ':include :type=code :fragment=request')
...
| Parameter | Required? | Type | Value example | Description |
|-------------|--------|-------------|------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|
| **get** | Yes | String | `"https://api.Optimism.us/api/v3/exchangeInfo?symbol=ETHUSD"` | The URL to which to send the HTTP request for data                                                                                          |
...
* Use the following curl command to test out the above request directly against the provided HTTP endpoint: `curl -k -X GET -H "content-type:application/json" "https://api.Optimism.us/api/v3/exchangeInfo?symbol=ETHUSD"`
...
[get_bool_constructor_om](/Optimism/get_bool/get_bool.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_bool_request_om](/Optimism/get_bool/get_bool.sol ':include :type=code :fragment=request')
...
<!-- | Address                                    | JobID                            | Job Cost              | -->
<!-- |--------------------------------------------|----------------------------------|-----------------------| -->
<!-- | [0xbF974f8faf696229854D70E5030CC6CA01A34c4B](https://optimistic.etherscan.io/address/0xbF974f8faf696229854D70E5030CC6CA01A34c4B) | 5b48fe6ac244436bb5ad689ab64ef28b | 0.15 LINK                | -->
| Address and Job ID | Job Cost |
|-------------------|----------|
...
[get_bytes_constructor_om](/Optimism/get_bytes/get_bytes.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_bytes_request_om](/Optimism/get_bytes/get_bytes.sol ':include :type=code :fragment=request')
...
<!-- | Address                                    | JobID                            | Job Cost              | -->
<!-- |--------------------------------------------|----------------------------------|-----------------------| -->
<!-- | [0xbF974f8faf696229854D70E5030CC6CA01A34c4B](https://optimistic.etherscan.io/address/0xbF974f8faf696229854D70E5030CC6CA01A34c4B) | 1cc553d092584937bfe9be9a3dd4c1f6 | 0.15 LINK                | -->
| Address and Job ID | Job Cost |
|-------------------|----------|
| Please complete our [**onboarding form**](https://linkwellnodes.io/Getting-Started.html) to reveal our mainnet **Addresses** and **Job IDs** | 0.15 LINK |
...
[get_string_constructor_om](/Optimism/get_string/get_string.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_string_request_om](/Optimism/get_string/get_string.sol ':include :type=code :fragment=request')
...
<!-- | Address                                    | JobID                            | Job Cost              | -->
<!-- |--------------------------------------------|----------------------------------|-----------------------| -->
<!-- | [0xbF974f8faf696229854D70E5030CC6CA01A34c4B](https://optimistic.etherscan.io/address/0xbF974f8faf696229854D70E5030CC6CA01A34c4B) | be46cb8070c14cb7ad058b29f127ec6b | 0.15 LINK                | -->
| Address and Job ID | Job Cost |
|-------------------|----------|
| Please complete our [**onboarding form**](https://linkwellnodes.io/Getting-Started.html) to reveal our mainnet **Addresses** and **Job IDs** | 0.15 LINK |
...
[get_string_x2_constructor_om](/Optimism/get_string_x2/get_string_x2.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_string_x2_request_om](/Optimism/get_string_x2/get_string_x2.sol ':include :type=code :fragment=request')
...
<!-- | Address                                    | JobID                            | Job Cost              | -->
<!-- |--------------------------------------------|----------------------------------|-----------------------| -->
<!-- | [0xbF974f8faf696229854D70E5030CC6CA01A34c4B](https://optimistic.etherscan.io/address/0xbF974f8faf696229854D70E5030CC6CA01A34c4B) | fe82fb4d00794483a1cf5ed23bd5e1b7 | 0.15 LINK                | -->
| Address and Job ID | Job Cost |
|-------------------|----------|
| Please complete our [**onboarding form**](https://linkwellnodes.io/Getting-Started.html) to reveal our mainnet **Addresses** and **Job IDs** | 0.15 LINK |
...
[get_uint256_x2_constructor_om](/Optimism/get_uint256_x2/get_uint256_x2.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_uint256_x2_request_om](/Optimism/get_uint256_x2/get_uint256_x2.sol ':include :type=code :fragment=request')
...
<!-- | Address                                    | JobID                            | Job Cost              | -->
<!-- |--------------------------------------------|----------------------------------|-----------------------| -->
<!-- | [0xbF974f8faf696229854D70E5030CC6CA01A34c4B](https://optimistic.etherscan.io/address/0xbF974f8faf696229854D70E5030CC6CA01A34c4B) | 9a2ba54374f34184bdc6390db3171994 | 0.15 LINK                | -->
| Address and Job ID | Job Cost |
|-------------------|----------|
| Please complete our [**onboarding form**](https://linkwellnodes.io/Getting-Started.html) to reveal our mainnet **Addresses** and **Job IDs** | 0.15 LINK |
...
| Parameter | Required? | Type | Value example | Description |
|-------------|--------|-------------|------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|
| **get** | Yes | String | `"https://api.Optimism.us/api/v3/depth?symbol=ETHUSD"` | The URL to which to send the HTTP request for data                                                                                          |
...
* Use the following curl command to test out the above request directly against the provided HTTP endpoint: `curl -k -X GET -H "content-type:application/json" "https://api.Optimism.us/api/v3/depth?symbol=ETHUSD"`
...
[get_uint256_array_constructor_om](/Optimism/get_uint256_array/get_uint256_array.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_uint256_array_request_om](/Optimism/get_uint256_array/get_uint256_array.sol ':include :type=code :fragment=request')
...
<!-- | Address                                    | JobID                            | Job Cost              | -->
<!-- |--------------------------------------------|----------------------------------|-----------------------| -->
<!-- | [0xbF974f8faf696229854D70E5030CC6CA01A34c4B](https://optimistic.etherscan.io/address/0xbF974f8faf696229854D70E5030CC6CA01A34c4B) | 332c0b46e57f49cd8c7d74cdbe5106ab | 0.15 LINK                | -->
| Address and Job ID | Job Cost |
|-------------------|----------|
| Please complete our [**onboarding form**](https://linkwellnodes.io/Getting-Started.html) to reveal our mainnet **Addresses** and **Job IDs** | 0.15 LINK |
...
[get_bytes_array_constructor_om](/Optimism/get_bytes_array/get_bytes_array.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_bytes_array_request_om](/Optimism/get_bytes_array/get_bytes_array.sol ':include :type=code :fragment=request')
...
[post_bytes_constructor_om](/Optimism/post_bytes/post_bytes.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[post_bytes_request_om](/Optimism/post_bytes/post_bytes.sol ':include :type=code :fragment=request')
...
[post_uint256_constructor_om](/Optimism/post_uint256/post_uint256.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[post_uint256_request_om](/Optimism/post_uint256/post_uint256.sol ':include :type=code :fragment=request')
