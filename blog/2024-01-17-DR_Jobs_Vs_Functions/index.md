...
authors: [Ken, Derek]
tags: [chainlink, oracle, custom data feed, functions, any api]
---
...
Yet, after the release of Functions, a lingering question remains - are Direct Requests still viable?
...
![Chainlink Functions](./Chainlink-Functions-Diagram.png)<center>**https://blog.chain.link/introducing-chainlink-functions/**</center>
...
>
> They provide self-service oracle solutions across 14 mainnet (and 13 testnet) blockchains, and offer free smart contract development and monitoring for all Any API (Direct) requests.