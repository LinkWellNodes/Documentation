...
Please see below for our Chainlink direct request job offerings on the Ethereum-Sepolia network.  All testnet jobs are free to use, and do not require you to prefund your contracts with the LINK token.  If you run into any trouble, we are here to help!  Head on over to our [**Discord**](https://discord.gg/AJ66pRz4), or feel free to contact us [**here**](https://linkwellnodes.io/Home.html#contact-us "Contact LinkWell Nodes")!
...
[get_uint256_constructor_est](/Ethereum-Sepolia/get_uint256/get_uint256.sol ':include :type=code :fragment=constructor')
...
[get_uint256_request_est](/Ethereum-Sepolia/get_uint256/get_uint256.sol ':include :type=code :fragment=request')
...
[get_uint256_no_multiply_constructor_est](/Ethereum-Sepolia/get_uint256_no_multiply/get_uint256_no_multiply.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_uint256_request_no_multiply_est](/Ethereum-Sepolia/get_uint256_no_multiply/get_uint256_no_multiply.sol ':include :type=code :fragment=request')
...
[get_int256_constructor_est](/Ethereum-Sepolia/get_int256/get_int256.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_int256_request_est](/Ethereum-Sepolia/get_int256/get_int256.sol ':include :type=code :fragment=request')
...
[get_bool_constructor_est](/Ethereum-Sepolia/get_bool/get_bool.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_bool_request_est](/Ethereum-Sepolia/get_bool/get_bool.sol ':include :type=code :fragment=request')
...
[get_bytes_constructor_est](/Ethereum-Sepolia/get_bytes/get_bytes.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_bytes_request_est](/Ethereum-Sepolia/get_bytes/get_bytes.sol ':include :type=code :fragment=request')
...
[get_string_constructor_est](/Ethereum-Sepolia/get_string/get_string.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_string_request_est](/Ethereum-Sepolia/get_string/get_string.sol ':include :type=code :fragment=request')
...
[get_string_x2_constructor_est](/Ethereum-Sepolia/get_string_x2/get_string_x2.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_string_x2_request_est](/Ethereum-Sepolia/get_string_x2/get_string_x2.sol ':include :type=code :fragment=request')
...
[get_uint256_x2_constructor_est](/Ethereum-Sepolia/get_uint256_x2/get_uint256_x2.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_uint256_x2_request_est](/Ethereum-Sepolia/get_uint256_x2/get_uint256_x2.sol ':include :type=code :fragment=request')
...
[get_uint256_array_constructor_est](/Ethereum-Sepolia/get_uint256_array/get_uint256_array.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_uint256_array_request_est](/Ethereum-Sepolia/get_uint256_array/get_uint256_array.sol ':include :type=code :fragment=request')
...
[get_bytes_array_constructor_est](/Ethereum-Sepolia/get_bytes_array/get_bytes_array.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_bytes_array_request_est](/Ethereum-Sepolia/get_bytes_array/get_bytes_array.sol ':include :type=code :fragment=request')
...
[post_bytes_constructor_est](/Ethereum-Sepolia/post_bytes/post_bytes.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[post_bytes_request_est](/Ethereum-Sepolia/post_bytes/post_bytes.sol ':include :type=code :fragment=request')
...
[post_uint256_constructor_est](/Ethereum-Sepolia/post_uint256/post_uint256.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[post_uint256_request_est](/Ethereum-Sepolia/post_uint256/post_uint256.sol ':include :type=code :fragment=request')
