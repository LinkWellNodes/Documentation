...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/mainnets/Polygon/string-bytes/string-bytes.sol#L47-L57
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/mainnets/Polygon/string-bytes-array/string-bytes-array.sol#L47-L59
```
