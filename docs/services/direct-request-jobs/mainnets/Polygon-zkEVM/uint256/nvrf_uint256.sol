...
contract LinkWellNVRFUint256ConsumerContractExample is ChainlinkClient, ConfirmedOwner {
    ...
    function fulfill(bytes32 requestId, uint256 _randomValue) public recordChainlinkFulfillment(requestId) {
