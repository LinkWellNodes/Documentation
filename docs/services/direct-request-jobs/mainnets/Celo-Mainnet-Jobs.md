...
Celo is a platform acting as a global payment infrastructure for cryptocurrencies that aims to target mobile users. CELO is the network's native cryptocurrency, which is used for fees, staking, and more.

Please see below for our Chainlink data feed offerings ('**jobs**') on the Celo network. If you run into any trouble, we are here to help! Head on over to our [Discord server](https://discord.gg/AJ66pRz4), or feel free to contact us [here](https://linkwellnodes.io/Home.html#contact-us "Contact LinkWell Nodes")!
