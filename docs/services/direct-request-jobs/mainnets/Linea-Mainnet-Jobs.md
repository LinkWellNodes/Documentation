...
Please see below for our Chainlink data feed offerings ('**jobs**') on the Linea network. If you run into any trouble, we are here to help! Head on over to our [Discord server](https://discord.gg/Xs6SjqVPUA), or feel free to contact us [here](https://linkwellnodes.io/#contact-us "Contact LinkWell Nodes")!
