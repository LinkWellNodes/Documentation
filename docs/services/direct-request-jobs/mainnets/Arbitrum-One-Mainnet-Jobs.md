...
:::info 
This job uses LinkWell Nodes's [VRN service](/knowledgebase/Verifiable-Random-Numbers-Guide) - a cryptographically-secure and independently-verifiable random number generator (RNG) that sends random numbers to your on-chain smart contract.
:::
