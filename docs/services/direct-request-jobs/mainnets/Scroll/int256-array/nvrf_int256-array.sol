...
contract LinkWellVRNInt256ArrConsumerContractExample is ChainlinkClient, ConfirmedOwner {
    ...
    int256[] public randomValue;

    // Receive the result from the Chainlink oracle
    event RequestFulfilled(bytes32 indexed requestId);
    function fulfill(bytes32 requestId, int256[] memory _randomValue) public recordChainlinkFulfillment(requestId) {
