...
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_uint256/get_uint256.sol#L22-L27
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_uint256/get_uint256.sol#L29-L42
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_uint256_no_multiply/get_uint256_no_multiply.sol#L22-L27
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_uint256_no_multiply/get_uint256_no_multiply.sol#L29-L40
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_int256/get_int256.sol#L22-L27
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_int256/get_int256.sol#L29-L43
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_bool/get_bool.sol#L22-L27
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_bool/get_bool.sol#L29-L37
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_bytes/get_bytes.sol#L24-L29
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_bytes/get_bytes.sol#L31-L42
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_string/get_string.sol#L24-L29
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_string/get_string.sol#L31-L43
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_string_x2/get_string_x2.sol#L29-L34
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_string_x2/get_string_x2.sol#L36-L53
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_uint256_x2/get_uint256_x2.sol#L30-L35
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_uint256_x2/get_uint256_x2.sol#L37-L55
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_uint256_array/get_uint256_array.sol#L21-L26
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_uint256_array/get_uint256_array.sol#L28-L36
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_bytes_array/get_bytes_array.sol#L22-L27
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/get_bytes_array/get_bytes_array.sol#L29-L37
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/post_bytes/post_bytes.sol#L23-L28
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/post_bytes/post_bytes.sol#L30-L43
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/post_uint256/post_uint256.sol#L23-L28
```
...
```sol reference showLineNumbers
https://github.com/LinkWellNodes/Documentation/blob/docusaurus/docs/services/direct-request-jobs/mainnets/Binance/post_uint256/post_uint256.sol#L30-L45
```
