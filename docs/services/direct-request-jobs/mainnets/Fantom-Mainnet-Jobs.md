...
The Fantom network is an open-source, scalable, EVM-compatible, and secure smart-contract platform. FTM is used to pay for transactions on Fantom Mainnet.

Please see below for our Chainlink data feed offerings ('**jobs**') on the Fantom network. If you run into any trouble, we are here to help! Head on over to our [Discord server](https://discord.gg/AJ66pRz4), or feel free to contact us [here](https://linkwellnodes.io/Home.html#contact-us "Contact LinkWell Nodes")!
