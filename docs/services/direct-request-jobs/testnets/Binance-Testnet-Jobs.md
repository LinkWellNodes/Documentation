...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Binance-Testnet/string-bytes/string-bytes.sol#L52-L62
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Binance-Testnet/string-bytes-array/string-bytes-array.sol#L52-L64
```
