---
title: Arbitrum (ARB) Sepolia Testnet Oracle Addresses
description: Connect your smart contract to the internet using our customizable Chainlink oracle data feeds running on the Arbitrum (ARB) Sepolia testnet network.  
---
...
The below documentation illustrates how to integrate a custom Chainlink data feed for your smart contract or dApp running on the Arbitrum Sepolia network. All testnet data feeds are **free to use**, and do not require you to fund your contracts with the LINK token. If you run into any trouble, head on over to our [Discord server](https://discord.gg/Xs6SjqVPUA) for the fastest assistance, or feel free to contact us [here](https://linkwellnodes.io/#contact-us "Contact LinkWell Nodes").
...
|--------------------------------------------|----------------------------------|-----------------------|
| [0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46](https://sepolia.arbiscan.io/address/0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46) | a8356f48569c434eaa4ac5fcb4db5cc0 | 0 LINK | -->
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256/uint256.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256/uint256.sol#L22-L26
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256/uint256.sol#L29-L49
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256/uint256.sol#L51-L59
```
...
<!-- | Oracle Address                             | Job ID                           | Fee       |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46](https://sepolia.arbiscan.io/address/0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46) | 92b7c5a0307545d9ad032f00523605a0 | 0 LINK | -->
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256/vrn_uint256.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256/vrn_uint256.sol#L33-L37
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256/vrn_uint256.sol#L44-L61
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256/vrn_uint256.sol#L63-L95
```
...
<!-- | Oracle Address                             | Job ID                           | Fee       |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46](https://sepolia.arbiscan.io/address/0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46) | e20c7567b2bb4e3690c615d03457b5d3 | 0 LINK | -->
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256-array/uint256-array.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256-array/uint256-array.sol#L22-L26
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256-array/uint256-array.sol#L29-L49
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256-array/uint256-array.sol#L51-L59
```
...
<!-- | Oracle Address                             | Job ID                           | Fee       |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46](https://sepolia.arbiscan.io/address/0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46) | 1b9b1967e5084cb59c2f04bcfc5307cb | 0 LINK | -->
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256-array/vrn_uint256-array.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256-array/vrn_uint256-array.sol#L33-L37
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256-array/vrn_uint256-array.sol#L45-L64
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/uint256-array/vrn_uint256-array.sol#L66-L98
```
...
<!-- | Oracle Address                             | Job ID                           | Fee       |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46](https://sepolia.arbiscan.io/address/0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46) | 7f221811c63d49dd98031f957bf9bce0 | 0 LINK | -->
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256/int256.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256/int256.sol#L22-L26
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256/int256.sol#L29-L49
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256/int256.sol#L51-L59
```
...
<!-- | Oracle Address                             | Job ID                           | Fee       |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46](https://sepolia.arbiscan.io/address/0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46) | 0e58feb938b044b2a342639c10d9eef4 | 0 LINK | -->
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256/vrn_int256.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256/vrn_int256.sol#L33-L37
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256/vrn_int256.sol#L44-L61
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256/vrn_int256.sol#L63-L95
```
...
<!-- | Oracle Address                             | Job ID                           | Fee       |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46](https://sepolia.arbiscan.io/address/0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46) | 356a0aced8f7425abd2ec17df9014359 | 0 LINK | -->
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256-array/int256-array.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256-array/int256-array.sol#L22-L26
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256-array/int256-array.sol#L29-L49
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256-array/int256-array.sol#L51-L59
```
...
<!-- | Oracle Address                             | Job ID                           | Fee       |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46](https://sepolia.arbiscan.io/address/0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46) | 6e8063b1ced54163aadddc5237c6d04e | 0 LINK | -->
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256-array/vrn_int256-array.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256-array/vrn_int256-array.sol#L33-L37
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256-array/vrn_int256-array.sol#L45-L64
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/int256-array/vrn_int256-array.sol#L66-L98
```
...
<!-- | Oracle Address                             | Job ID                           | Fee       |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46](https://sepolia.arbiscan.io/address/0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46) | 43309009a154495cb2ed794233e6ff56 | 0 LINK | -->
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/bool/bool.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/bool/bool.sol#L22-L26
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/bool/bool.sol#L29-L48
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/bool/bool.sol#L50-L58
```
...
<!-- | Oracle Address                             | Job ID                           | Fee       |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46](https://sepolia.arbiscan.io/address/0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46) | 433ba6a76b374e2580dd43685a9de8c6 | 0 LINK | -->
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/bool-array/bool-array.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/bool-array/bool-array.sol#L22-L26
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/bool-array/bool-array.sol#L29-L48
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/bool-array/bool-array.sol#L50-L58
```
...
<!-- | Oracle Address                             | Job ID                           | Fee       |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46](https://sepolia.arbiscan.io/address/0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46) | 8ced832954544a3c98543c94a51d6a8d | 0 LINK | -->
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/string-bytes/string-bytes.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/string-bytes/string-bytes.sol#L22-L26
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/string-bytes/string-bytes.sol#L29-L48
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/string-bytes/string-bytes.sol#L50-L63
```
...
<!-- | Oracle Address                             | Job ID                           | Fee       |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46](https://sepolia.arbiscan.io/address/0xd36c6B1777c7f3Db1B3201bDD87081A9045B7b46) | 07f761e26a284cb8b7ed67188dece6d4 | 0 LINK | -->
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/string-bytes-array/string-bytes-array.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/string-bytes-array/string-bytes-array.sol#L22-L26
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/string-bytes-array/string-bytes-array.sol#L29-L48
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Arbitrum-Sepolia/string-bytes-array/string-bytes-array.sol#L50-L63
```
