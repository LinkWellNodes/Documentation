---
title: Fantom (FTM) Testnet Oracle Addresses
description: Connect your smart contract to the internet using our customizable Chainlink oracle data feeds running on the Fantom (FTM) testnet network.  
---
...
The below documentation illustrates how to integrate a custom Chainlink data feed for your smart contract or dApp running on the Fantom Testnet network. All testnet data feeds are **free to use**, and do not require you to fund your contracts with the LINK token. If you run into any trouble, head on over to our [Discord server](https://discord.gg/Xs6SjqVPUA) for the fastest assistance, or feel free to contact us [here](https://linkwellnodes.io/#contact-us "Contact LinkWell Nodes").
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256/uint256.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256/uint256.sol#L23-L28
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256/uint256.sol#L31-L51
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256/uint256.sol#L53-L61
```
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256/nvrf_uint256.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256/nvrf_uint256.sol#L23-L28
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256/nvrf_uint256.sol#L31-L42
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256/nvrf_uint256.sol#L44-L52
```
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256-array/uint256-array.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256-array/uint256-array.sol#L23-L28
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256-array/uint256-array.sol#L31-L51
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256-array/uint256-array.sol#L53-L61
```
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256-array/nvrf_uint256-array.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256-array/nvrf_uint256-array.sol#L23-L28
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256-array/nvrf_uint256-array.sol#L31-L43
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/uint256-array/nvrf_uint256-array.sol#L45-L53
```
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256/int256.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256/int256.sol#L23-L28
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256/int256.sol#L31-L51
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256/int256.sol#L53-L61
```
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256/nvrf_int256.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256/nvrf_int256.sol#L23-L28
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256/nvrf_int256.sol#L31-L42
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256/nvrf_int256.sol#L44-L52
```
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256-array/int256-array.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256-array/int256-array.sol#L23-L28
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256-array/int256-array.sol#L31-L51
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256-array/int256-array.sol#L53-L61
```
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256-array/nvrf_int256-array.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256-array/nvrf_int256-array.sol#L23-L28
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256-array/nvrf_int256-array.sol#L31-L43
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/int256-array/nvrf_int256-array.sol#L45-L53
```
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/bool/bool.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/bool/bool.sol#L23-L28
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/bool/bool.sol#L30-L50
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/bool/bool.sol#L52-L60
```
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/bool-array/bool-array.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/bool-array/bool-array.sol#L23-L28
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/bool-array/bool-array.sol#L30-L50
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/bool-array/bool-array.sol#L52-L60
```
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/string-bytes/string-bytes.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/string-bytes/string-bytes.sol#L23-L28
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/string-bytes/string-bytes.sol#L30-L50
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/string-bytes/string-bytes.sol#L52-L65
```
...
:::tip
For easy editing, you can also open our sample contract [directly in Remix](https://remix.ethereum.org/#activate=github&url=https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/string-bytes-array/string-bytes-array.sol).
:::
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/string-bytes-array/string-bytes-array.sol#L23-L28
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/string-bytes-array/string-bytes-array.sol#L30-L50
```

#### 3. Retrieve the response (example):

```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Fantom-Testnet/string-bytes-array/string-bytes-array.sol#L52-L69
```
