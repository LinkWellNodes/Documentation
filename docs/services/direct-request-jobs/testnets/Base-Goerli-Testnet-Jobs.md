...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Base-Goerli/string-bytes/string-bytes.sol#L52-L65
```
...
```sol reference
https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Base-Goerli/string-bytes-array/string-bytes-array.sol#L52-L69
```
