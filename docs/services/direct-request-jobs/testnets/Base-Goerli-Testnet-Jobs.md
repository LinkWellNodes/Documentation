...
Base Goerli is the testnet of Layer 2 rollup chain Base mainnet, and uses Ethereum's Goerli testnet network as its Layer 1 protocol.
...
|--------------------------------------------|----------------------------------|-----------------------|
| [0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f](https://goerli.basescan.org/address/0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f) | a8356f48569c434eaa4ac5fcb4db5cc0 | 0 LINK |
...
[uint256_constructor](/Base-Goerli/uint256/uint256.sol ':include :type=code :fragment=constructor')`

#### 2. Add your request function (example):
The 'request' function defines the request parameters and sends the request to the Chainlink oracle. For detailed information on each required parameter, reference the above '**Request parameters**' section:

[uint256_request](/Base-Goerli/uint256/uint256.sol ':include :type=code :fragment=request')

#### 3. Retrieve the response (example):

[uint256_response](/Base-Goerli/uint256/uint256.sol ':include :type=code :fragment=response')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Base-Goerli/uint256/uint256.sol) of the above consumer contract.
...
| Oracle Address                             | Job ID                           | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f](https://goerli.basescan.org/address/0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f) | e20c7567b2bb4e3690c615d03457b5d3 | 0 LINK |
...
[uint256-array_constructor](/Base-Goerli/uint256-array/uint256-array.sol ':include :type=code :fragment=constructor')`
...
[uint256-array_request](/Base-Goerli/uint256-array/uint256-array.sol ':include :type=code :fragment=request')

#### 3. Retrieve the response (example):

[uint256-array_response](/Base-Goerli/uint256-array/uint256-array.sol ':include :type=code :fragment=response')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Base-Goerli/uint256-array/uint256-array.sol) of the above consumer contract.
...
| Oracle Address                             | Job ID                           | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f](https://goerli.basescan.org/address/0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f) | 7f221811c63d49dd98031f957bf9bce0 | 0 LINK |
...
[int256_constructor](/Base-Goerli/int256/int256.sol ':include :type=code :fragment=constructor')`

#### 2. Add your request function (example):
The 'request' function defines the request parameters and sends the request to the Chainlink oracle. For detailed information on each required parameter, reference the above '**Request parameters**' section:

[int256_request](/Base-Goerli/int256/int256.sol ':include :type=code :fragment=request')

#### 3. Retrieve the response (example):

[int256_response](/Base-Goerli/int256/int256.sol ':include :type=code :fragment=response')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Base-Goerli/int256/int256.sol) of the above consumer contract.
...
| Oracle Address                             | Job ID                           | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f](https://goerli.basescan.org/address/0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f) | 356a0aced8f7425abd2ec17df9014359 | 0 LINK |
...
[int256-array_constructor](/Base-Goerli/int256-array/int256-array.sol ':include :type=code :fragment=constructor')`

#### 2. Add your request function (example):
The 'request' function defines the request parameters and sends the request to the Chainlink oracle. For detailed information, reference the above '**Request parameters**' section:

[int256-array_request](/Base-Goerli/int256-array/int256-array.sol ':include :type=code :fragment=request')

#### 3. Retrieve the response (example):

[int256-array_response](/Base-Goerli/int256-array/int256-array.sol ':include :type=code :fragment=response')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Base-Goerli/int256-array/int256-array.sol) of the above consumer contract.
...
| Oracle Address                             | Job ID                           | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f](https://goerli.basescan.org/address/0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f) | 43309009a154495cb2ed794233e6ff56 | 0 LINK |
...
[bool_constructor](/Base-Goerli/bool/bool.sol ':include :type=code :fragment=constructor')`

#### 2. Add your request function (example):
The 'request' function defines the request parameters and sends the request to the Chainlink oracle. For detailed information, reference the above '**Request parameters**' section:

[bool_request](/Base-Goerli/bool/bool.sol ':include :type=code :fragment=request')

#### 3. Retrieve the response (example):

[bool_response](/Base-Goerli/bool/bool.sol ':include :type=code :fragment=response')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Base-Goerli/bool/bool.sol) of the above consumer contract.
...
| Oracle Address                             | Job ID                           | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f](https://goerli.basescan.org/address/0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f) | 433ba6a76b374e2580dd43685a9de8c6 | 0 LINK |
...
[bool-array_constructor](/Base-Goerli/bool-array/bool-array.sol ':include :type=code :fragment=constructor')`

#### 2. Add your request function (example):
The 'request' function defines the request parameters and sends the request to the Chainlink oracle. For detailed information, reference the above '**Request parameters**' section:

[bool-array_request](/Base-Goerli/bool-array/bool-array.sol ':include :type=code :fragment=request')

#### 3. Retrieve the response (example):

[bool-array_response](/Base-Goerli/bool-array/bool-array.sol ':include :type=code :fragment=response')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Base-Goerli/bool-array/bool-array.sol) of the above consumer contract.
...
| Oracle Address                             | Job ID                           | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f](https://goerli.basescan.org/address/0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f) | 8ced832954544a3c98543c94a51d6a8d | 0 LINK |
...
[string-bytes_constructor](/Base-Goerli/string-bytes/string-bytes.sol ':include :type=code :fragment=constructor')`

#### 2. Add your request function (example):
The 'request' function defines the request parameters and sends the request to the Chainlink oracle. For detailed information, reference the above '**Request parameters**' section:

[string-bytes_request](/Base-Goerli/string-bytes/string-bytes.sol ':include :type=code :fragment=request')

#### 3. Retrieve the response (example):

[string-bytes_response](/Base-Goerli/string-bytes/string-bytes.sol ':include :type=code :fragment=response')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Base-Goerli/string-bytes/string-bytes.sol) of the above consumer contract.
...
| Oracle Address                             | Job ID                           | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f](https://goerli.basescan.org/address/0xa57f0cEd49bB1ed7327f950B12a8419cFD01855f) | 07f761e26a284cb8b7ed67188dece6d4 | 0 LINK |
...
[string-bytes-array_constructor](/Base-Goerli/string-bytes-array/string-bytes-array.sol ':include :type=code :fragment=constructor')`

#### 2. Add your request function (example):
The 'request' function defines the request parameters and sends the request to the Chainlink oracle. For detailed information, reference the above '**Request parameters**' section:

[string-bytes-array_request](/Base-Goerli/string-bytes-array/string-bytes-array.sol ':include :type=code :fragment=request')

#### 3. Retrieve the response (example):

[string-bytes-array_response](/Base-Goerli/string-bytes-array/string-bytes-array.sol ':include :type=code :fragment=response')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Base-Goerli/string-bytes-array/string-bytes-array.sol) of the above consumer contract.
