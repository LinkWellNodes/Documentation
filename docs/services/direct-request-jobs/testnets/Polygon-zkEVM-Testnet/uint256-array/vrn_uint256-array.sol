...
contract LinkWellVRNUint256ArrConsumerContractExample is ChainlinkClient, ConfirmedOwner {
    ...
    uint256[] public latestRandomNumbers;
    ...
    function storeResultForVerification(bytes32 requestId, uint256[] memory _randomNumbers, bytes32 hash) internal {
    ...
    function getRandomNumbers(bytes32 requestId) internal view returns (uint256[] memory) {
