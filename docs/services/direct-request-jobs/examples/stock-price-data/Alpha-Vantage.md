...
The following guide illustrates an easy example of how to retrieve Alpha Vantage data from within your blockchain smart contract, using our highly-resilient Chainlink node infrastructure as an oracle for your data needs.
...
In order to retrieve data from the Alpha Vantage API, you'll need an API key. Luckily, Alpha Vantage provides API keys for free, and ipsum dolor sit amet.
