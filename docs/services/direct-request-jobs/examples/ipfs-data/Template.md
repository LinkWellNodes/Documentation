...
?> You'll need to replace `ADD_CHAINLINK_TOKEN_ADDRESS_HERE` and `ADD_ORACLE_ADDRESS_HERE` with the addresses appropriate to the specific blockchain that you'll be using. You can find these values within our [Direct Request Job Documentation](/services/direct-request-jobs/Jobs-and-Pricing).
