...
The following guide illustrates an easy example of how to retrieve a `uint256[]` (number array) value from TheRundown API, and write it to your blockchain smart contract using our highly-resilient Chainlink oracle infrastructure.
