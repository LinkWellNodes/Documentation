## Optimism-Goerli Testnet Jobs

Optimism-Goerli is the testnet of Layer 2 rollup chain Optimism, and uses Ethereum's Goerli testnet network as its Layer 1 protocol.

Please see below for our Chainlink direct request job offerings on the Optimism-Goerli network. All testnet jobs are free to use, and do not require you to fund your contracts with the LINK token. If you run into any trouble, we are here to help! Head on over to our [Discord](https://discord.gg/AJ66pRz4), or feel free to contact us [here](https://linkwellnodes.io/Home.html#contact-us "Contact LinkWell Nodes")!
...
|--------------------------------------------|----------------------------------|-----------------------|
| [0x14bc7F6Da6cA3E072793c185e01a76E62341CC61](https://goerli-optimism.etherscan.io/address/0x14bc7F6Da6cA3E072793c185e01a76E62341CC61) | f4821ba2e8ae4ddba52ea6860887df96 | 0 LINK                |
...
[get_uint256_constructor_ogt](/Optimism-Goerli/get_uint256/get_uint256.sol ':include :type=code :fragment=constructor')
...
[get_uint256_request_ogt](/Optimism-Goerli/get_uint256/get_uint256.sol ':include :type=code :fragment=request')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_uint256/get_uint256.sol) of the above consumer contract.
* View the [actual oracle job](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_uint256/get_uint256.toml) that LinkWell's oracles use to fulfill the above request.
...
| Address                                    | JobID                            | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0x14bc7F6Da6cA3E072793c185e01a76E62341CC61](https://goerli-optimism.etherscan.io/address/0x14bc7F6Da6cA3E072793c185e01a76E62341CC61) | 65cfa14a158540e1a8a94f9a33163839 | 0 LINK                |
...
[get_uint256_no_multiply_constructor_ogt](/Optimism-Goerli/get_uint256_no_multiply/get_uint256_no_multiply.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_uint256_request_no_multiply_ogt](/Optimism-Goerli/get_uint256_no_multiply/get_uint256_no_multiply.sol ':include :type=code :fragment=request')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_uint256_no_multiply/get_uint256_no_multiply.sol) of the above consumer contract.
* View the [actual oracle job](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_uint256_no_multiply/get_uint256_no_multiply.toml) that LinkWell's oracles use to fulfill the above request.
...
| Address                                    | JobID                            | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0x14bc7F6Da6cA3E072793c185e01a76E62341CC61](https://goerli-optimism.etherscan.io/address/0x14bc7F6Da6cA3E072793c185e01a76E62341CC61) | 339ac1ad0a864ea7b94811de8a362a64 | 0 LINK                |
...
[get_int256_constructor_ogt](/Optimism-Goerli/get_int256/get_int256.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_int256_request_ogt](/Optimism-Goerli/get_int256/get_int256.sol ':include :type=code :fragment=request')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_int256/get_int256.sol) of the above consumer contract.
* View the [actual oracle job](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_int256/get_int256.toml) that LinkWell's oracles use to fulfill the above request.
...
| Address                                    | JobID                            | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0x14bc7F6Da6cA3E072793c185e01a76E62341CC61](https://goerli-optimism.etherscan.io/address/0x14bc7F6Da6cA3E072793c185e01a76E62341CC61) | 2e0a430bcd2b482d8462fdcc5224fba1 | 0 LINK                |
...
[get_bool_constructor_ogt](/Optimism-Goerli/get_bool/get_bool.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_bool_request_ogt](/Optimism-Goerli/get_bool/get_bool.sol ':include :type=code :fragment=request')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_bool/get_bool.sol) of the above consumer contract.
* View the [actual oracle job](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_bool/get_bool.toml) that LinkWell's oracles use to fulfill the above request.
...
| Address                                    | JobID                            | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0x14bc7F6Da6cA3E072793c185e01a76E62341CC61](https://goerli-optimism.etherscan.io/address/0x14bc7F6Da6cA3E072793c185e01a76E62341CC61) | 5b48fe6ac244436bb5ad689ab64ef28b | 0 LINK                |
...
[get_bytes_constructor_ogt](/Optimism-Goerli/get_bytes/get_bytes.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_bytes_request_ogt](/Optimism-Goerli/get_bytes/get_bytes.sol ':include :type=code :fragment=request')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_bytes/get_bytes.sol) of the above consumer contract.
* View the [actual oracle job](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_bytes/get_bytes.toml) that LinkWell's oracles use to fulfill the above request.
...
| Address                                    | JobID                            | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0x14bc7F6Da6cA3E072793c185e01a76E62341CC61](https://goerli-optimism.etherscan.io/address/0x14bc7F6Da6cA3E072793c185e01a76E62341CC61) | 1cc553d092584937bfe9be9a3dd4c1f6 | 0 LINK                |
...
[get_string_constructor_ogt](/Optimism-Goerli/get_string/get_string.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_string_request_ogt](/Optimism-Goerli/get_string/get_string.sol ':include :type=code :fragment=request')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_string/get_string.sol) of the above consumer contract.
* View the [actual oracle job](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_string/get_string.toml) that LinkWell's oracles use to fulfill the above request.
...
| Address                                    | JobID                            | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0x14bc7F6Da6cA3E072793c185e01a76E62341CC61](https://goerli-optimism.etherscan.io/address/0x14bc7F6Da6cA3E072793c185e01a76E62341CC61) | be46cb8070c14cb7ad058b29f127ec6b | 0 LINK                |
...
[get_string_x2_constructor_ogt](/Optimism-Goerli/get_string_x2/get_string_x2.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_string_x2_request_ogt](/Optimism-Goerli/get_string_x2/get_string_x2.sol ':include :type=code :fragment=request')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_string_x2/get_string_x2.sol) of the above consumer contract.
* View the [actual oracle job](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_string_x2/get_string_x2.toml) that LinkWell's oracles use to fulfill the above request.
...
| Address                                    | JobID                            | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0x14bc7F6Da6cA3E072793c185e01a76E62341CC61](https://goerli-optimism.etherscan.io/address/0x14bc7F6Da6cA3E072793c185e01a76E62341CC61) | fe82fb4d00794483a1cf5ed23bd5e1b7 | 0 LINK                |
...
[get_uint256_x2_constructor_ogt](/Optimism-Goerli/get_uint256_x2/get_uint256_x2.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_uint256_x2_request_ogt](/Optimism-Goerli/get_uint256_x2/get_uint256_x2.sol ':include :type=code :fragment=request')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_uint256_x2/get_uint256_x2.sol) of the above consumer contract.
* View the [actual oracle job](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_uint256_x2/get_uint256_x2.toml) that LinkWell's oracles use to fulfill the above request.
...
| Address                                    | JobID                            | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0x14bc7F6Da6cA3E072793c185e01a76E62341CC61](https://goerli-optimism.etherscan.io/address/0x14bc7F6Da6cA3E072793c185e01a76E62341CC61) | 9a2ba54374f34184bdc6390db3171994 | 0 LINK                |
...
[get_uint256_array_constructor_ogt](/Optimism-Goerli/get_uint256_array/get_uint256_array.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_uint256_array_request_ogt](/Optimism-Goerli/get_uint256_array/get_uint256_array.sol ':include :type=code :fragment=request')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_uint256_array/get_uint256_array.sol) of the above consumer contract.
* View the [actual oracle job](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_uint256_array/get_uint256_array.toml) that LinkWell's oracles use to fulfill the above request.
...
| Address                                    | JobID                            | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0x14bc7F6Da6cA3E072793c185e01a76E62341CC61](https://goerli-optimism.etherscan.io/address/0x14bc7F6Da6cA3E072793c185e01a76E62341CC61) | 332c0b46e57f49cd8c7d74cdbe5106ab | 0 LINK                |
...
[get_bytes_array_constructor_ogt](/Optimism-Goerli/get_bytes_array/get_bytes_array.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[get_bytes_array_request_ogt](/Optimism-Goerli/get_bytes_array/get_bytes_array.sol ':include :type=code :fragment=request')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_bytes_array/get_bytes_array.sol) of the above consumer contract.
* View the [actual oracle job](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/get_bytes_array/get_bytes_array.toml) that LinkWell's oracles use to fulfill the above request.
...
| Address                                    | JobID                            | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0x14bc7F6Da6cA3E072793c185e01a76E62341CC61](https://goerli-optimism.etherscan.io/address/0x14bc7F6Da6cA3E072793c185e01a76E62341CC61) | b3390c03bfc24b42a0b0ab8051471bbb | 0 LINK                |
...
[post_bytes_constructor_ogt](/Optimism-Goerli/post_bytes/post_bytes.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[post_bytes_request_ogt](/Optimism-Goerli/post_bytes/post_bytes.sol ':include :type=code :fragment=request')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/post_bytes/post_bytes.sol) of the above consumer contract.
* View the [actual oracle job](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/post_bytes/post_bytes.toml) that LinkWell's oracles use to fulfill the above request.
...
| Address                                    | JobID                            | Job Cost              |
|--------------------------------------------|----------------------------------|-----------------------|
| [0x14bc7F6Da6cA3E072793c185e01a76E62341CC61](https://testnet.arbiscan.io/address/0x14bc7F6Da6cA3E072793c185e01a76E62341CC61) | b090204b16644030844a6e91932a7626 | 0 LINK                |
...
[post_uint256_constructor_ogt](/Optimism-Goerli/post_uint256/post_uint256.sol ':include :type=code :fragment=constructor')

#### Add your request function (example):
The 'request function' within your consumer contract specifies the parameters to be sent over with your Chainlink request - the requirements for which are outlined in the above 'Request parameters' section:

[post_uint256_request_ogt](/Optimism-Goerli/post_uint256/post_uint256.sol ':include :type=code :fragment=request')

### View the full source code

* View a [full example](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/post_uint256/post_uint256.sol) of the above consumer contract.
* View the [actual oracle job](https://github.com/LinkWellNodes/Documentation/blob/main/docs/services/direct-request-jobs/testnets/Optimism-Goerli/post_uint256/post_uint256.toml) that LinkWell's oracles use to fulfill the above request.
