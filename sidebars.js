module.exports = {
  docsSidebar: [
    ...
    {
        type: 'html',
        value: '<div class="sidebarGroupTitle">Chainlink Data Feeds</div><hr class="sidebarGroupRuler">',
        defaultStyle: true
    },
	{
		type: 'doc',
		id: 'services/direct-request-jobs/Jobs-and-Pricing',
		label: 'Overview',
	},
	{
		type: 'category',
...
},
{
    ...
    {
        type: 'html',
        value: '<div class="sidebarGroupTitle">Advisory</div><hr class="sidebarGroupRuler">',
        defaultStyle: true
    },
    {
  	  type: 'doc',
    ...
    {
        type: 'html',
        value: '<div class="sidebarGroupTitle">Miscellaneous</div><hr class="sidebarGroupRuler">',
        defaultStyle: true
    },
	{
	    type: 'category',
